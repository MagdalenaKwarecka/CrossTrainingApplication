...
public class RegistrationController {
    ...
    public RegistrationController(PersonService personService, PersonValidator personValidator, EmailSenderImpl emailSender) {
    ...
    public ResponseEntity<String> save(@RequestBody Person person) {return personValidator.coachMessage(person);
    }
